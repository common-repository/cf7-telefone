=== CF7 Telefone ===
Contributors: Lucas
Tags: mascara telefone, telefone cf7, contact form telefone, contact form tel, cf7-mask, cf7 telefone, cf7-telefone
...
1. Search for `cf7-telefone'
1. Clica em "Instalar Agora"
1. Finaliza clicando em "Activate Plugin & Run CF7 Telefone"

Se você preferir, você pode instalar de forma manualmente.

1. Suba a pasta `cf7-telefone` para a pasta `/wp-content/plugins/`
